...
function CardAboutMe() {
  return (
    <section className="cardAboutMe">
      <h2>About Me</h2>
      <p>
        I'm a Mechanical Engineer with 4 years of experience in engineering
        projects development , and now I have been dedicated the last year
        exclusively to web development.
      </p>
      <div className="img">
