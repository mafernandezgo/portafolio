    ...
    <div className="modalMoreInfo">
        <div className="modalContainer">
                ...
                <div className="tagsWrapper">
                    ...
                    <div className="tags">
                        { sortTags.map( x => { return (<div className="tag"> {x} </div>)})}
                    </div>
                </div>
                <div className="links">
                    ...
                    <a className={`${unavailableLink === "" && "unavailable"} neumorphism link`} href={deployUrl} target="_blank">
                        <div>
                            <GrDeploy />
                        </div>
                    </a>
